...
class MessageBubble(ft.Container):
    ...
    def __init__(self, message: dict):
        ...
        if is_info:
            client_color = ft.Colorss.GREY_700
            bg_color = ft.Colorss.GREY_200
        elif is_error:
            client_color = ft.Colorss.RED_600
            bg_color = ft.Colorss.RED_100 # Brighter for error background
        else: # Server or Client
            client_color = ft.Colorss.BLUE_600 if is_server else ft.Colorss.GREEN_600
            bg_color = ft.Colorss.BLUE_50 if is_server else ft.Colorss.GREEN_50
        ...
        content = ft.Column(
            controls=[
                ...
                ft.Text(
                    ...
                    color=ft.Colorss.GREY_600,  # Adjusted grey
                    selectable=True
                ),
            ],
            spacing=4,
...
class DeviceTab(ft.Container):
    ...
    def __init__(self, device_name: str):
        ...
        self.content = ft.Container(
            ...
            expand=True,
            border=ft.border.all(1, ft.Colorss.GREY_400), # Adjusted border color
            padding=10
        )
                ...
                controls=[
                    ...
                    ft.IconButton(
                        ...
                        style=ft.ButtonStyle(
                            color={"hovered": ft.Colorss.RED_700}, # Adjusted hover color
                            padding=5
                        )
                    )
                ],
